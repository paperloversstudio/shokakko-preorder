...
import type { ImageSectionData } from "@/lib/validations/event-page";
...
export function ImageSectionEditor({
  ...
  return (
    <form action={formAction} className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ...
          onChange={async (e) => {
            ...
            // Recompress before it ever sits in the form — see
      ...
      <Field label="Caption (optional)" htmlFor="caption" error={state.fieldErrors?.caption}>
