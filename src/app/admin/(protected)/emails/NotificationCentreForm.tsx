...
import { generateEmail, type DigestFormState } from "./actions";
    ...
    <form action={formAction} className="flex flex-col gap-5">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          type="button"
          disabled
          title="Real email sending is coming in a future sprint"
          className="cursor-not-allowed rounded-pill bg-ink/10 px-4 py-2 text-sm font-semibold text-ink-soft"
        >
          Send Update — coming in Sprint 4
        </button>
      </div>
    </form>
  );
